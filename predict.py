...
def transform_data(features_dict):
    ...
    # reshape array to 2D: one sample with 30 features
    arr = arr.reshape(1, -1)
...
false_dict = {
    ...
    'radius_error': 0.245265,
    'texture_error': 0.096645,
    'perimeter_error': 0.222824,
    'area_error': 0.166695,
    'smoothness_error': 0.092837,
    'compactness_error': 0.107159,
    'concavity_error': 0.057298,
    'concave_points_error': 0.259519,
    'symmetry_error': 0.111576,
    'fractal_dimension_error': 0.027749,
    'worst_radius': 0.591404,
    'worst_texture': 0.388060,
    'worst_perimeter': 0.566367,
    'worst_area': 0.407503,
    'worst_smoothness': 0.326903,
    'worst_compactness': 0.226562,
    'worst_concavity': 0.214617,
    'worst_concave_points': 0.614777,
    'worst_symmetry': 0.194362,
    'worst_fractal_dimension': 0.091980
}
